...
import { getMealPlanTemplates, getMealPlanAssignments } from './actions'
...
export default async function MealPlansPage() {
  ...
  const [templates, assignments] = await Promise.all([
    ...
    getMealPlanAssignments(workspaceId),
  ])

  return <MealPlansClient templates={templates} assignments={assignments} />
}
