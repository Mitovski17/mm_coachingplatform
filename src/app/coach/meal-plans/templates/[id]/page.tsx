...
import { getMealPlanTemplate } from '../../actions'
...
export default async function EditMealPlanTemplatePage({
  params,
}: {
  ...
  const template = await getMealPlanTemplate(id)
  if (!template) notFound()
  return <MealPlanEditor workspaceId={workspaceId} initialData={template} />
}
